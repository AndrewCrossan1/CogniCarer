...
export function TemplateCard({template}: { template: Template }) {
    ...
    return (
        <View style={styles.container} className={"border-solid border bg-neutral-200 dark:bg-neutral-900 dark:border-neutral-900 border-neutral-300 rounded-lg my-2 p-4"}>
